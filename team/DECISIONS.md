...
| D-010 | 2026-09-08 | Jira workspace created: site <https://careerbridge-csi5324.atlassian.net>, space **CareerBridge**, **Scrum** template, workflow To Do → In Progress → In Review → Done. Amends D-009: the `atlassian` plugin is enabled at **project** scope (`.claude/settings.json`), shared by the whole team, not just Oleg's environment. | Setup by Oleg, Sep 8, 2026. |
